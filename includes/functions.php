...
function uploadFile($file, $allowedTypes = ['jpg', 'jpeg', 'png', 'gif'], $maxSize = 
5242880, $uploadDir = 'assets/uploads/') { 
    ...
    if ($file['size'] > $maxSize) { 
        return ['success' => false, 'message' => 'File is too large. Maximum size is ' . 
($maxSize / 1048576) . 'MB']; 
    } 
    ...
    if (!in_array($fileExtension, $allowedTypes)) { 
        return ['success' => false, 'message' => 'Invalid file type. Allowed: ' . 

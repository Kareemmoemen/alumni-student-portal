...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add') {
        ...
        if ($skill_name === '') {
            ...
            $query = "INSERT INTO skills (user_id, skill_name, skill_level) 
...
function getSkillLevelClass(array $skill): string {
    $level = strtolower($skill['skill_level'] ?? ($skill['level'] ?? 'beginner'));
...
<head>
    ...
    <!-- PDF Skills Page Styles (syntax-fixed, otherwise unchanged) -->
    <style>
    .skills-container {
        max-width: 900px;
        margin: 40px auto;
    ...
    .skill-icon.beginner { background: #fff3cd; }
    .skill-icon.intermediate { background: #cfe2ff; }
    .skill-icon.advanced { background: #d1e7dd; }
...
<body style="background:#f5f7fa;">
    ...
    <!-- Navigation (same pattern as dashboard/profile) -->
    <nav class="navbar">
            ...
            <form method="post" class="add-skill-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="skill_name" id="skill_name"
                           class="form-control" placeholder="e.g., Python, Public Speaking">
                </div>
